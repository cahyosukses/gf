...
if (! function_exists('ConvertToUnixTime')) {
	function ConvertToUnixTime($String) {
		$String = (strlen($String) == 10) ? $String . ' 00:00:00' : $String;
...
if (! function_exists('GetNormalDateFromFullDate')) {
	function GetNormalDateFromFullDate($String) {
		$ArrayDate = ConvertDateToArray($String);
...
if (! function_exists('GetNormalTimeFromFullDate')) {
	function GetNormalTimeFromFullDate($String) {
		$ArrayDate = ConvertDateToArray($String);
		
		return $ArrayDate['Hour'] . ':' . $ArrayDate['Minute'];
	}
}
...
if (! function_exists('GetSlashDate')) {
	function GetSlashDate($String, $Param = array()) {
		$String = (strlen($String) > 10) ? substr($String, 0, 10) : $String;
		if ($String == '0000-00-00') {
			return '';
		}
